...
<head>
    <meta charset="UTF-8">
    <title>{{ $isAr ? 'أهلاً بك' : 'Welcome' }}</title>
</head>
        ...
        <tr><td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 18px rgba(0,0,0,.06);">
                <tr><td style="background:linear-gradient(135deg,#FF4040 0%,#FF6B6B 100%);padding:28px 30px;color:#fff;">
                    <h1 style="margin:0;font-size:22px;">{{ $isAr ? 'أهلاً بك في هوت سبوت! 🎉' : 'Welcome to Hotspot! 🎉' }}</h1>
                </td></tr>
                <tr><td style="padding:30px;">
                    ...
                    <p style="font-size:15px;line-height:1.7;color:#374151;margin:0 0 18px;">
                        {{ $isAr
                            ? 'تم تفعيل حسابك بنجاح. يمكنك الآن تقديم طلبات التمويل ومتابعتها بسهولة من لوحة التحكم.'
                            : 'Your account is now active. You can submit and track your financing requests directly from your dashboard.' }}
                    </p>
                    ...
                    <p style="font-size:13px;color:#6b7280;line-height:1.7;margin:0;">
                        {{ $isAr
                            ? 'إذا كان لديك أي استفسار، فريق الدعم لدينا جاهز للمساعدة.'
